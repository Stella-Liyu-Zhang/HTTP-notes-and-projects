...
1) All the headers are shown from the GET request, as we could see from below:

I made a GET request on Thomas's Twitter main page. Here are several headers:
